    ...
    return (
      <Component
        className={clsx(
          ...
          {
            // Primary (gradient)
            'bg-gradient-brand text-white shadow-brand hover:shadow-brand-lg focus:ring-purple-500 hover:scale-105':
              variant === 'primary',
            
            // Secondary (outline)
            'border-2 border-purple-500 text-purple-600 bg-white hover:bg-purple-50 focus:ring-purple-500':
              variant === 'secondary',
